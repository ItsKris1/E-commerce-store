...
urlpatterns = [
    ...
    path('product_details/<int:pk>',
         views.ProductDetailsView.as_view(), name='product_details'),
    ...
    path('add_single_item_to_cart/<int:pk>',
    ...
    # -
    path('billing_shipping', views.BillingShippingView.as_view(),
         name='billing_shipping'),

    # path('finished_order', views.FinishOrder.as_view(), name='finished_order'),
    path('payment', views.PaymentView.as_view(), name='payment'),
    path('payment_succesful', views.PaymentSuccessful.as_view(),
         name='payment_succesful'),
    ...
    # PROFILE
    path('profile/<int:pk>', views.UserProfileDetailsView.as_view(),
         name='profile_view'),
    path('profile/edit/<int:pk>', views.profile_update_view,
         name='profile_update_view'),
    path('profile/delete_user/<int:pk>',
         views.UserProfileDeleteView.as_view(), name='profile_delete')
]
